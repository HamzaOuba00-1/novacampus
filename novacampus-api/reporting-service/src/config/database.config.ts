 ...
 * reporting (novacampus_reporting).
 *
 * Ce service est principalement en LECTURE sur les données
 * des autres services (via leurs APIs). Sa propre base stocke :
 *   – Les snapshots KPI calculés (cache persisté)
 *   – Les alertes IA générées
 *   – Les exports en attente
 *
